...
public class Robot extends TimedRobot {
  ...
  public PWMTalonSRX setupPWMTalonSRX(int port, Sides side, boolean inverted) {
    // create new motor and set neutral modes (if needed)
    PWMTalonSRX motor = new PWMTalonSRX(port);
  ...
  public void robotInit() {
    ...
    // create left motor
    PWMTalonSRX leftMotor = setupPWMTalonSRX(1, Sides.LEFT, false);

    ArrayList<SpeedController> leftMotors = new ArrayList<SpeedController>();
    leftMotors.add(setupPWMTalonSRX(2, Sides.FOLLOWER, false));
    ...
    PWMTalonSRX rightMotor = setupPWMTalonSRX(3, Sides.RIGHT, false);
    ArrayList<SpeedController> rightMotors = new ArrayList<SpeedController>();
    rightMotors.add(setupPWMTalonSRX(4, Sides.FOLLOWER, false));
